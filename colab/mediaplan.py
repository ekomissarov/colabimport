...
class MP:
    ...
    tags = [
        ...
        {"descr": 'spb_realweb_brand_search_bdg', "fltrs": ["spb_.*brand_cian.*search_rw", ]},
        {"descr": 'spb_realweb_tovarnaya_bdg', "fltrs": ["spb_.*tovarnaya.*_rw", ]},
        {"descr": 'spb_realweb_smart_bdg', "fltrs": ["spb_.*smart.*_rw", ]},
        {"descr": 'spb_realweb_search_bdg', "fltrs": ["spb_.*_search_rw", ]},
        {"descr": 'spb_realweb_other_bdg', "fltrs": ["spb_.*_rw", ]},
        {"descr": 'ekb_realweb_brand_search_bdg', "fltrs": ["ekb_.*brand_cian.*search_rw", ]},
        {"descr": 'ekb_realweb_tovarnaya_bdg', "fltrs": ["ekb_.*tovarnaya.*_rw", ]},
        {"descr": 'ekb_realweb_smart_bdg', "fltrs": ["ekb_.*smart.*_rw", ]},
        {"descr": 'ekb_realweb_search_bdg', "fltrs": ["ekb_.*_search_rw", ]},
        {"descr": 'ekb_realweb_other_bdg', "fltrs": ["ekb_.*_rw", ]},
        {"descr": 'novosibirsk_realweb_brand_search_bdg', "fltrs": ["novosibirsk_.*brand_cian.*search_rw", "nsk_.*brand_cian.*search_rw", ]},
        {"descr": 'novosibirsk_realweb_tovarnaya_bdg', "fltrs": ["novosibirsk_.*tovarnaya.*_rw", "nsk_.*tovarnaya.*_rw", ]},
        {"descr": 'novosibirsk_realweb_smart_bdg', "fltrs": ["novosibirsk_.*smart.*_rw", "nsk_.*smart.*_rw", ]},
        {"descr": 'novosibirsk_realweb_search_bdg', "fltrs": ["novosibirsk_.*_search_rw", "nsk_.*_search_rw", ]},
        {"descr": 'novosibirsk_realweb_other_bdg', "fltrs": ["novosibirsk_.*_rw", "nsk_.*_rw", ]},
        {"descr": 'omskcity_realweb_brand_search_bdg', "fltrs": ["omsk_.*brand_cian.*search_rw", ]},
        {"descr": 'omskcity_realweb_tovarnaya_bdg', "fltrs": ["omsk_.*tovarnaya.*_rw", ]},
        {"descr": 'omskcity_realweb_smart_bdg', "fltrs": ["omsk_.*smart.*_rw", ]},
        {"descr": 'omskcity_realweb_search_bdg', "fltrs": ["omsk_.*_search_rw", ]},
        ...
        # Пакет: brand_cian ##################################################################
        ######################################################################################
        {"descr": 'msk_brand_cian_experimental_bdg', "fltrs": ["b2c_msk_brand_cian_all_mix_search_ongoing", ]},
        ...
        {"descr": 'msk_interests_salesec_network_bdg', "fltrs": ["b2c_msk_rsya_interests_all_mix_network",
                                                                 "b2c_msk_rsya_interests_salesec_mix_network",
                                                                 ]},
        ...
        {"descr": 'krasnodar_sub_network_bdg', "fltrs": ["b2c_krasnodar_general_null_sub_mix_network",
                                                         "b2c_krasnodar_rsya_sub_all_mix_network", ]},
