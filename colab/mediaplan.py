...
class MP:
    ...
    tags = [
        ...
        {"descr": 'omsk_realweb_brand_search_bdg', "fltrs": ["omsk_.*brand_cian.*search_rw", ]},
        {"descr": 'omsk_realweb_tovarnaya_bdg', "fltrs": ["omsk_.*tovarnaya.*_rw", ]},
        {"descr": 'omsk_realweb_smart_bdg', "fltrs": ["omsk_.*smart.*_rw", ]},
        {"descr": 'omsk_realweb_search_bdg', "fltrs": ["omsk_.*_search_rw", ]},
        {"descr": 'omsk_realweb_other_bdg', "fltrs": ["omsk_.*_rw", ]},
